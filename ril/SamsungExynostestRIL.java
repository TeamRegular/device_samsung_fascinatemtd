...
public class SamsungExynostestRIL extends RIL implements CommandsInterface {
    ...
    public SamsungExynostestRIL(Context context, int networkMode, int cdmaSubscription) {
